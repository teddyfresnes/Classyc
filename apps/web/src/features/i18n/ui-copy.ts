...
export const uiCopies: Record<SupportedLanguageCode, UiCopy> = {
	fr: {
		...
		nameIntroTitle: "Comment tu t'appelles ?",
		namePlaceholder: 'Alex',
		onboardingTitle: 'Choisis tes langues',
		progress: 'Progression',
		start: 'Commencer',
		streak: 'Série',
		settings: 'Paramètres',
		notifications: 'Notifications',
		targetDisabled: 'Déjà choisie',
		...
		navigation: {
			...
			leaderboard: {
				...
				description: 'Ligues, rangs et progression sociale.'
			},
			friends: {
				label: 'Amis',
				shortLabel: 'Amis',
	...
	en: {
		...
		nameIntroTitle: "What's your name?",
		namePlaceholder: 'Alex',
		onboardingTitle: 'Choose your languages',
		progress: 'Progress',
		start: 'Start',
		streak: 'Streak',
		settings: 'Settings',
		notifications: 'Notifications',
		targetDisabled: 'Already selected',
		...
		navigation: {
			...
			leaderboard: {
				label: 'Leaderboard',
				shortLabel: 'League',
				description: 'Leagues, ranks and social progress.'
			},
			friends: {
				label: 'Friends',
				shortLabel: 'Friends',
	...
	zh: {
		...
		nameIntroTitle: '你叫什么名字？',
		namePlaceholder: 'Alex',
		onboardingTitle: '选择语言',
		progress: '进度',
		start: '开始',
		streak: '连续',
		settings: '设置',
