...
export function FrenchExerciseDeck({ exercises = frenchStarterExercises }: FrenchExerciseDeckProps) {
	...
	return (
		<div className="exercise-deck" aria-label="Exercices français">
			<header className="exercise-deck__header">
				<div className="min-w-0">
					<p className="exercise-deck__eyebrow">Français</p>
					<h1 className="exercise-deck__title">Premiers exercices</h1>
				</div>
